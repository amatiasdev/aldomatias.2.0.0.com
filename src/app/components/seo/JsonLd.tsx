...
export function WebSiteJsonLd() {
  const websiteSchema = {
    ...
    url: 'https://aldomatias.com',
    description:
      'n8n automation, security audits, and AWS infrastructure services. Results in 1-2 weeks.',
    author: {
      '@type': 'Person',
      name: 'Aldo Matias',
    },
    ...
    step: [
      {
        ...
        text: 'Fill out the form with your project details. No commitment required.',
      },
      {
        '@type': 'HowToStep',
        position: 2,
        name: 'Receive your proposal in 48h',
        text: 'You receive a personalized proposal with exact scope and timeline tailored to your needs.',
      },
      {
        '@type': 'HowToStep',
        position: 3,
        name: 'Implementation in 1–2 weeks',
        text: 'Focused execution with measurable deliverables every 3 days and direct communication.',
      },
    ],
  };
