...
export default function ImageGalleryModal({
  ...
  return createPortal(
    <div
      className={`fixed inset-0 z-50 flex items-center justify-center bg-black/95 backdrop-blur-sm pointer-events-auto min-h-screen transition-opacity duration-200 ${
    ...
    >
      ...
      >
        ...
        <div
          {...swipeHandlers}
          key={currentIndex}
          className={`relative w-full max-w-5xl h-[58vh] md:h-[65vh] transition-all duration-200 ${
